...
<p class="d-flex justify-content-center">TIMESPAN AVERAGE / HOUR 00-<?php echo $jam?></p>
<table>
    <tr>
        <td>Hour</td>
        <td>:</td>
                ...
                <?php
                                                ...
                                                FROM
                                                    ...
                                                    SELECT
                                                        CALLING_DATE,
                                                        HR,
                                                        SUBSTR(SUM(SLM04 + SLM05 + SLM06 + SLM07 + PAS12 + PAS13)/ 6, 1, 5) AS AVGP
                                                    FROM
                                                        RBTRPTN_REPORT_TIMESPAN
                                                    WHERE
                                                        HR BETWEEN '00' AND '$jam'
                                                    GROUP BY
                                                        CALLING_DATE,
                                                        HR) pivot (AVG(AVGP) FOR CALLING_DATE IN ($monthly,
                                                    $fourteenago,
                                                    $weekly,
                                                    $twodaysago,
                                                    $yesterday,
                                                ...
                                                ORDER BY
													...
													while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
														...
														echo "
                                                                                ...
                                                                                <td>" . $row[4] . "</td>
                                                                                <td class='table-secondary'>" . $row[5] . "</td>
                                                                                <td>" . $row[6] . "</td>";
														echo "
																			</tr>";

...
<p class="d-flex justify-content-center">ATTEMPT GRACEPERIODE / HOUR 00-<?php echo $jam?></p>
<table>
    <tr>
        <td>Hour</td>
        <td>:</td>
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,ATTEMPT FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Grace Periode'))
    ...
    <div class="col-lg-3">
        <div class="card" style="width: 100%;">
            <div class="card-body">
                ...
                <hr>
                <?php 
                $nama = "chart_ATTEMPT_GRACEPERIODE";
                $type = "GRACEPERIODE";
                $title = "ATTEMPT";
...
<p class="d-flex justify-content-center">REVENUE GRACEPERIODE / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,REVENUE FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Grace Periode'))
    ...
    <div class="col-lg-3">
        <div class="card" style="width: 100%;">
            <div class="card-body">
                ...
                <hr>
                <?php 
                $nama = "chart_REVENUE_GRACEPERIODE";
                $type = "GRACEPERIODE";
                $title = "REVENUE";
                $charts->diagram_garis($totalSum_monthly,$totalSum_weekly,$totalSum_fourteenago,$totalSum_twodaysago,$totalSum_yesterday,$totalSum_today,$monthly,$weekly,$fourteenago,$twodaysago,$yesterday,$today,$jam,$nama,$type,$title); 
                ?>
...
<p class="d-flex justify-content-center">SUCCESS GRACEPERIODE / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,SUCCESS FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Grace Periode'))
    ...
    <div class="col-lg-3">
        <div class="card" style="width: 100%;">
            <div class="card-body">
                ...
                <hr>
                <?php 
                $nama = "chart_SUCCESS_GRACEPERIODE";
                $type = "GRACEPERIODE";
                $title = "SUCCESS";
                $charts->diagram_garis($totalSum_monthly,$totalSum_weekly,$totalSum_fourteenago,$totalSum_twodaysago,$totalSum_yesterday,$totalSum_today,$monthly,$weekly,$fourteenago,$twodaysago,$yesterday,$today,$jam,$nama,$type,$title); 
                ?>

...
<p class="d-flex justify-content-center">ATTEMPT ALL CHANNEL / HOUR 00-<?php echo $jam?></p>
<table>
    <tr>
        <td>Hour</td>
        <td>:</td>
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT calling_date,channel,attempt FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Purchase ON','Purchase OFF'))
														pivot (sum (ATTEMPT) FOR CALLING_DATE IN ($monthly,$fourteenago,$weekly,$twodaysago,$yesterday,$today)) ORDER BY channel");
													oci_execute($stid);
                                                    $totalSum_monthly = 0;
...
<p class="d-flex justify-content-center">REVENUE ALL CHANNEL / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
                <tr>
                    <th>CHANNEL</th>
                    <th>
                        <div class="btn-group dropright btn-group-sm">
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT calling_date,channel,revenue FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Purchase ON','Purchase OFF'))
														pivot (sum (REVENUE) FOR CALLING_DATE IN ($monthly,$fourteenago,$weekly,$twodaysago,$yesterday,$today)) ORDER BY channel");
													oci_execute($stid);
                                                    $totalSum_monthly = 0;
                                                    $totalSum_fourteenago = 0;
                                                    $totalSum_weekly = 0;
...
<p class="d-flex justify-content-center">SUCCESS ALL CHANNEL / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT calling_date,channel,SUCCESS FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Purchase ON','Purchase OFF'))
														pivot (sum (SUCCESS) FOR CALLING_DATE IN ($monthly,$fourteenago,$weekly,$twodaysago,$yesterday,$today)) ORDER BY channel");
													oci_execute($stid);
                                                    $totalSum_monthly = 0;
                                                    $totalSum_fourteenago = 0;
                                                    $totalSum_weekly = 0;

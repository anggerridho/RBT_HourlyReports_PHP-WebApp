<?php
    ...
    // echo "</pre>";
?>
<!-- <a class="btn btn-secondary btn-sm " href="#ATTEMPT_RENEWAL"> ATTEMPT </a> <a class="btn btn-secondary btn-sm"
    href="#REVENUE_RENEWAL"> REVENUE </a> <a class="btn btn-secondary btn-sm" href="#SUCCESS_RENEWAL"> SUCCESS </a> <a
    class="btn btn-secondary btn-sm" href="#ERROR_CODE_RENEWAL"> ERROR_CODE </a> -->
<p class="d-flex justify-content-center" id="ATTEMPT_RENEWAL">ATTEMPT RENEWAL / HOUR 00-<?php echo $jam?></p>
<table>
    <tr>
        <td>Hour</td>
        <td>:</td>
            ...
            <tbody>
                <?php
													...
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,ATTEMPT FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal ON','Renewal OFF'))
...
<p class="d-flex justify-content-center" id="REVENUE_RENEWAL">REVENUE RENEWAL / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,REVENUE FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal ON','Renewal OFF'))
...
<p class="d-flex justify-content-center" id="SUCCESS_RENEWAL">SUCCESS RENEWAL / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,SUCCESS FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal ON','Renewal OFF'))

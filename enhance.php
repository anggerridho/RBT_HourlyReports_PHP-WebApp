...
<p class="d-flex justify-content-center">ATTEMPT ENHANCE / HOUR 00-<?php echo $jam?></p>
<table>
    <tr>
        <td>Hour</td>
        <td>:</td>
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,ATTEMPT FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal Retry Enhance'))
...
<p class="d-flex justify-content-center">REVENUE ENHANCE / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,REVENUE FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal Retry Enhance'))
...
<p class="d-flex justify-content-center">SUCCESS ENHANCE / HOUR 00-<?php echo $jam?></p>
<div class="row justify-content-md-right">
    <div class="col-lg-9 table-responsive w-auto text-center">
        <table class="table table-bordered table-light table-sm table-hover table-striped">
            <thead class="thead-dark">
    ...
    <?php 
            ...
            <tbody>
                <?php
													$stid = oci_parse($conn, "SELECT * FROM (
														SELECT hr,calling_date,SUCCESS FROM RBTRPTN_REPORT_HOURLY WHERE hr BETWEEN '00' AND '$jam' AND trx IN ('Renewal Retry Enhance'))
